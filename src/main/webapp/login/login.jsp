    ...
    <script>
        $(function () {
            $("#loginButtonId").click(function () {
                    $.ajax({
                        url: "${pageContext.request.contextPath}/cmfz/login",
                        type: "post",
                        data: {
                        ...
                        success: function (data) {
                            if (data == "") {
                                $(window).attr('location', '${pageContext.request.contextPath}/main/page.jsp');
                            } else {
                                $("#st").text(data)
                            }
                        }
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "/cmfz/${pageContext.request.contextPath}/code?t=" + new Date().getTime())
            });
        });
    </script>
</head>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on:<span id="st" style="color: red"></span></p>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="width: 100px; height: 50px" class="captchaImage"
                                     src="/cmfz/${pageContext.request.contextPath}/code">
