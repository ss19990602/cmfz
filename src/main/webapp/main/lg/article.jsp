...
<script>
    $(function () {
        $("#articleList").jqGrid({
            url: "${pageContext.request.contextPath}/ArticleController/select",
            datatype: "json",
    ...
    function showModal() {
        ...
        KindEditor.create('#editor', {
            uploadJson: "${pageContext.request.contextPath}/TextController/upload",
            filePostName: "img",
            allowFileManager: true,
            fileManagerJson: "${pageContext.request.contextPath}/TextController/see",
            afterBlur: function () {
                this.sync();
            }
        });
    ...
    function addArticle() {
        $.ajax({
            url: "${pageContext.request.contextPath}/ArticleController/add",
            datatype: "json",
            type: "post",
    ...
    function updateArticle(id) {
        $.ajax({
            url: "${pageContext.request.contextPath}/ArticleController/update?id=" + id,
            datatype: "json",
            type: "post",
            data: $("#addArticleFrom").serialize(),
            success: function (data) {
